...
const projects: IProjectItem[] = [
  {
    ...
    // githubUrl: "",
    url: "www.secretjunction.com",
    tags: ["Wordpress", "Woo-Commerce", "PHP", "Paytm"],
  },
  {
    id: "real-estate-website",
    title: "Real Estate Website",
    description: "I developed a fully functional real estate website using WordPress, tailored to meet the unique needs of my client. Leveraging a robust and visually appealing theme, I customized various elements to align with the client's specifications and branding.",
    icon: "/skills/wordpress.svg",
    repoType: RepoType.Public,
    projectType: ProjectType.Freelance,
    // githubUrl: "",
    url: "www.sanandam.com",
